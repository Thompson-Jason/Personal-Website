...
const Skillblock = (props: PropsList) => {
  return (
    <div
      id={props.skill.name}
      className="bg-red-100 outline-double rounded-3xl flex flex-col justify-center items-center mx-auto"
    >
      <h1 className="flex items-center justify-center font-semibold text-4xl mt-5">
        {props.skill.name}
      </h1>
      <div className="flex justify-center my-5 px-5">{props.skill.desc}</div>
    </div>
  );
};
