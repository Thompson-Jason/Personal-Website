...
export const skillList: Array<Skill> = [
  ...
  {
    name: "TailwindCSS",
    desc: "I have been actively learning TailwindCSS and applying my knowledge to build a website, highlighting my growing proficiency with this utility-first CSS framework. Through hands-on experience, I have become adept at using TailwindCSS to create responsive and visually appealing designs with minimal custom CSS. This project illustrates my ability to efficiently style web applications using TailwindCSS, enhancing both development speed and design consistency.",
  },
  {
    name: "Jenkins",
    desc: "This is a skill that I developed over the course of my tenure at [24]7.ai. Jenkins was the CI/CD tool of choice for my team. During my time there, I used Jenkins almost every day, which mostly involved running already built Jenkinsfiles but also included improving the workflow or writing whole new workflows for new projects from scratch.",
  },
  {
    name: "Apache Maven",
    desc: "I often use Maven to build any Java project I am working on. It was also the build tool used at my previous company, [24]7.ai. I have extensive knowledge in Maven for updating and creating POM files.",
  },
  {
    name: "Git",
    desc: "I have been using Git for various projects, both professionally and personally. I started using Git in college, giving me seven years of experience using it.",
  },
  {
    name: "GitHub",
    desc: "I started using GitHub back in college for hosting my various projects. I have been exploring GitHub more and more as time goes on, which led me to learn GitHub Actions and various CI/CD practices from there. I recently received a Career Essentials in GitHub Professional Certificate in May 2024.",
  },
  {
    name: "Jira",
    desc: "I have a solid two-year background in using Jira, gained from my previous job where it was integral to our workflow. During this period, I consistently utilized Jira to track every story, ensuring all project tasks were meticulously documented and monitored.",
  },
  {
    name: "Agile Development",
    desc: "I have a robust understanding of Agile development, which I first learned during my final year of college. Over the past two years at [24]7.ai, I applied Agile methodologies extensively, participating in sprint planning, daily stand-ups, and retrospectives. My experience includes collaborating with cross-functional teams to deliver iterative improvements, ensuring flexibility, and continuously aligning project outcomes with customer needs.",
  },
  {
    name: "SQL",
    desc: "I started learning SQL about halfway through my college career, which gave me time to familiarize myself with the language before utilizing it at my previous job with [24]7.ai in a MySQL environment. While I only have professional experience with MySQL, I have a strong understanding of the fundamentals and am confident that I can utilize these skills in any SQL database type.",
  },
  {
    name: "Apache Kafka",
  ...
  {
    name: "Spring Boot",
    desc: "Spring Boot is a skill that I started learning a little over a year ago to expand my knowledge of Java. While I have not yet had the chance to use it professionally, I really like the framework and believe that it can be used to improve many codebases, even if just on a boilerplate level.",
  },
  {
    name: "Multithreading",
